...
(function ( $ ) {
    ...
    $.fn.drawValue = function( options ) {
        ...
        return this.each(function(i, item) {
            ...
            // Percent background
            var archtype = Raphael(settings.id, 200, 120),
            circlePositionTop = 60,
            circle = archtype.circle(50, circlePositionTop, 40).attr({stroke: "none", fill: "#96BDAA"}),
            
            // Percent lable
            text = archtype.text(50, circlePositionTop, settings.percentage + "%")
            ...
            var my_arc = archtype.path().attr({
                "stroke": "#00AA86",
                "stroke-width": 10,
                arc: [50, circlePositionTop, 0, 100, 40]
            });

            my_arc.animate({
                arc: [50, circlePositionTop, settings.percentage, 100, 40]
            }, 1500, "bounce");
